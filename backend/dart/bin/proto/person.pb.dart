...
class Person extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = new $pb.BuilderInfo('Person', package: const $pb.PackageName('messages'))
    ..aOS(1, 'name')
    ..a<int>(2, 'id', $pb.PbFieldType.O3)
    ..aOS(3, 'email')
    ..pp<$1.PhoneNumber>(4, 'phone', $pb.PbFieldType.PM, $1.PhoneNumber.$checkItem, $1.PhoneNumber.create)
  ...
  List<$1.PhoneNumber> get phone => $_getList(3);
}
